...
var SignUpView = AV.View.extend({
    ...
    var SubmitActivityView = AV.View.extend({
        ...
        initialize:function(){
            _.bindAll(this, "init_SubmitActivity","update_SubmitActivity");
            this.render();
        },
        
        render: function(){
            this.$el.html(_.template($("#template-page_submit_activity").html()));
            this.init_SubmitActivity();
            this.update_SubmitActivity();
        },
        
        init_SubmitActivity:function(){
             /*       获取对象*/
        ...
        update_SubmitActivity:function(){
            //获取对象
            var oActivityName = $("#activityName");
            var oActivityPlace = $("#activityPlace");
            var oActivityTime = $("#activityTime");
    ...
    /*更新活动发布预览页面*/
    var PreviewActivityView = AV.View.extend({
        el:$("#content"),
        
        initialize:function(){
            _.bindAll(this, "update_previewActivity");
            this.render();
            this.update_previewActivity();
        },
        
        update_previewActivity:function(){
        ...
        render: function(){
            this.$el.html(_.template($("#template-page_preview_activity").html()));
        }
    ...
    var UserpageView =AV.View.extend({
        el:$("#content"),
        ...
        render: function(){
            this.$el.html(_.template($("#template-page_userpage").html()));
        }
